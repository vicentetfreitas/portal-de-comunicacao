...
- `docs/database/ddl/002-create-sequences.sql`
- `docs/database/ddl/007-create-grants.sql`
- `docs/database/model/03-physical-model.md`
- `docs/database/model/04-entity-catalog.md`
- `docs/database/model/05-decisions-and-risks.md`
...
Permanecem abreviados **somente** quando o nome original excedia 30 caracteres. Nenhuma reversão necessária nesta revisão.
