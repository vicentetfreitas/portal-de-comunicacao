...
| Versão | 1.5 |
| Status | Approved |
| Baseline DDL | `docs/database/ddl/` (2026-07-10) |
...
- **Colaborador** armazena apenas atributos intrínsecos ao perfil (cargo como `DES_CARGO`, biografia, datas pessoais/profissionais, vínculo organizacional, gestor direto). Sem entidade `CARGO` nesta versão (DEC-DB-016).
- Gestores/líderes organizacionais: `AREA.COD_GESTOR`, `EQUIPE.COD_LIDER` e `COLABORADOR.COD_GESTOR` referenciam **Colaborador** — sem tabelas de hierarquia (DEC-DB-015/016).
