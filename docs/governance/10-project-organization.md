...
| 3 | Jira | D9: mapeamento Jira ↔ `feature.yaml` adiado; Jira “posteriormente” | Jira/Scrum como camada de acompanhamento | Camada válida como cadência **quando usada**. Não é obrigatória para executar Feature. Não é SSOT. |
