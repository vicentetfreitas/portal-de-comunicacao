#!/usr/bin/env bash
# PKG-FE-01 gate (BUILD-01): lint, typecheck, unit tests, build — no E2E
set -uo pipefail

REPO="$(cd "$(dirname "$0")/../.." && pwd)"
PKG_DIR="$REPO/construction/frontend/features/FT-EQUIPE/pkg-fe-01"
...
{
  echo "PKG-FE-01 evidence $(date -Iseconds)"
  echo "PWD: $(pwd)"
  echo ""
